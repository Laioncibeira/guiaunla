...
@Component({
  ...
  template: `
    ...
    <main>
      ...
      <p class="pie-fei">
        Hecha por estudiantes ·
        <a href="https://frente-de-estudiantes-de-izquierda-fei.web.app/" rel="noopener">FEI</a>
      </p>
    </main>
  `,
  styles: `
    ...
    .pie-fei { text-align: center; font-size: var(--t-xs); color: var(--texto-3); margin: 0; }
  `,
})
export class Inicio {
